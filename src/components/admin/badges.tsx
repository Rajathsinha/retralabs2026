...
const STATUS_STYLES: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  'PAYMENT_PROOF_SUBMITTED': { bg: 'bg-orange-100', text: 'text-orange-800', dot: 'bg-orange-500', label: 'Review Payment' },
  'PAYMENT_CONFIRMED':     { bg: 'bg-emerald-50', text: 'text-emerald-700', dot: 'bg-emerald-500', label: 'Paid' },
  'Logistics Failed':      { bg: 'bg-rose-100',   text: 'text-rose-800',    dot: 'bg-rose-500',    label: 'Shipping Failed' },
