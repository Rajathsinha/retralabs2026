...
export const PRODUCT_CONTENT: Record<string, ProductContent> = {
  'Retatrutide': {
    ...
    faqs: [
      ...
      { q: 'How do I verify Retatrutide purity and quality?', a: 'Every RetraLabs order (kits - 10 Vials) includes a Certificate of Analysis (COA) with the HPLC purity result (99.2%), batch number and identity confirmation. You can request the batch HPLC report to independently verify what you received.' },
