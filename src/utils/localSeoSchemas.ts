...
export function getServiceAreaSchema() {
  return {
    ...
    description: 'HPLC-verified research peptides shipped across India with temperature-controlled packaging. Same-day dispatch from Bengaluru to Bangalore, Mumbai, Delhi, Pune and all India.',
  };
}
